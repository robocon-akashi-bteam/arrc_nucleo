 ...
 *ScrpSlave(PinName TX1,PinName RX1,PinName REDE1,uint32_t
 *addr);//RedePinあり、１ポート ScrpSlave(PinName TX1,PinName RX1,PinName
 *TX2,PinName RX2,uint32_t addr);//RedePinなし、２ポート ScrpSlave(PinName
 *TX1,PinName RX1,PinName REDE1,PinName TX2,PinName RX2,uint32_t
 *addr);//RedePinあり、１ポート＋RedePinなし、１ポート example not usb port
